...
public class LR0Parser {
    ...
    public String getDerivation() {
        ...
        // TODO
        List<String> derivationList = new ArrayList<>(derivation);
        Collections.reverse(derivationList);
        return String.join("->", derivationList);
    ...
    public String getError() {
        //String errorMessage = "";
        // TODO
        return currentSymbol + " is an incorrect symbol";
